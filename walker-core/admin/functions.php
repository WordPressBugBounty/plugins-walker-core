...
function walker_core_get_templates_lists($theme_slug)
{
    ...
    switch ($theme_slug):
        ...
        case "nexum":
            $demo_templates_lists = array(
                'blockpage' => array(
                    'title' => esc_html__('Nexum', 'walker-core'),/*Title*/
                    'is_pro' => false,  /*Premium*/
                    'type' => 'free',
                    'author' => esc_html__('WalkerWP', 'walker-core'),    /*Author Name*/
                    'keywords' => array('nexum', 'walker-core'),  /*Search keyword*/
                    'categories' => array('free'), /*Categories*/
                    'template_url' => array(
                        'content' => WALKER_CORE_SETUP_TEMPLATE_URL . '/nexum/free/1/content.json',
                        'options' => WALKER_CORE_SETUP_TEMPLATE_URL . '/nexum/free/1/options.json',
                        'widgets' => WALKER_CORE_SETUP_TEMPLATE_URL . '/nexum/free/1/widgets.json'
                    ),
                    'screenshot_url' => WALKER_CORE_SETUP_TEMPLATE_URL . '/nexum/free/1/screenshot.png',
                    'demo_url' => 'https://demo.walkerwp.com/nexum',
                    'plugins' => ''
                ),
                'nexum-pro' => array(
                    'title' => esc_html__('Nexum Pro', 'walker-core'),/*Title*/
                    'is_pro' => true,  /*Premium*/
                    'type' => 'premium',
                    'author' => esc_html__('WalkerWP', 'walker-core'),    /*Author Name*/
                    'keywords' => array('nexum', 'walker-core'),  /*Search keyword*/
                    'categories' => array('pro'), /*Categories*/
                    'template_url' => array(
                        'content' => WALKER_CORE_SETUP_TEMPLATE_URL . '/nexum/pro/1/content.json',
                        'options' => WALKER_CORE_SETUP_TEMPLATE_URL . '/nexum/pro/1/options.json',
                        'widgets' => WALKER_CORE_SETUP_TEMPLATE_URL . '/nexum/pro/1/widgets.json'
                    ),
                    'screenshot_url' => WALKER_CORE_SETUP_TEMPLATE_URL . '/nexum/pro/1/screenshot.png',
                    'demo_url' => 'https://demo.walkerwp.com/nexum-pro',
                    'plugins' => ''
                ),
            );
            break;
        case "newsetmag":
            $demo_templates_lists = array(
                'blockpage' => array(
                    'title' => esc_html__('Newsetmag', 'walker-core'),/*Title*/
                    'is_pro' => false,  /*Premium*/
                    'type' => 'free',
                    'author' => esc_html__('WalkerWP', 'walker-core'),    /*Author Name*/
                    'keywords' => array('newsetmag', 'walker-core'),  /*Search keyword*/
                    'categories' => array('free'), /*Categories*/
                    'template_url' => array(
                        'content' => WALKER_CORE_SETUP_TEMPLATE_URL . '/newsetmag/free/1/content.json',
                        'options' => WALKER_CORE_SETUP_TEMPLATE_URL . '/newsetmag/free/1/options.json',
                        'widgets' => WALKER_CORE_SETUP_TEMPLATE_URL . '/newsetmag/free/1/widgets.json'
                    ),
                    'screenshot_url' => WALKER_CORE_SETUP_TEMPLATE_URL . '/newsetmag/free/1/screenshot.png',
                    'demo_url' => 'https://demo.walkerwp.com/newsetmag',
                    'plugins' => ''
                ),
                'newsetmag-pro' => array(
                    'title' => esc_html__('Newsetmag Pro', 'walker-core'),/*Title*/
                    'is_pro' => true,  /*Premium*/
                    'type' => 'premium',
                    'author' => esc_html__('WalkerWP', 'walker-core'),    /*Author Name*/
                    'keywords' => array('newsetmag', 'walker-core'),  /*Search keyword*/
                    'categories' => array('pro'), /*Categories*/
                    'template_url' => array(
                        'content' => WALKER_CORE_SETUP_TEMPLATE_URL . '/newsetmag/pro/1/content.json',
                        'options' => WALKER_CORE_SETUP_TEMPLATE_URL . '/newsetmag/pro/1/options.json',
                        'widgets' => WALKER_CORE_SETUP_TEMPLATE_URL . '/newsetmag/pro/1/widgets.json'
                    ),
                    'screenshot_url' => WALKER_CORE_SETUP_TEMPLATE_URL . '/newsetmag/pro/1/screenshot.png',
                    'demo_url' => 'https://demo.walkerwp.com/newsetmag-pro',
                    'plugins' => ''
                ),
            );
            break;
        case "fundifly-charity":
            $demo_templates_lists = array(
                'blockpage' => array(
                    'title' => esc_html__('Fundifly Charity', 'walker-core'),/*Title*/
                    'is_pro' => false,  /*Premium*/
                    'type' => 'free',
                    'author' => esc_html__('WalkerWP', 'walker-core'),    /*Author Name*/
                    'keywords' => array('fundifly-charity', 'walker-core'),  /*Search keyword*/
                    'categories' => array('free'), /*Categories*/
                    'template_url' => array(
                        'content' => WALKER_CORE_SETUP_TEMPLATE_URL . '/fundifly-charity/free/1/content.json',
                        'options' => WALKER_CORE_SETUP_TEMPLATE_URL . '/fundifly-charity/free/1/options.json',
                        'widgets' => WALKER_CORE_SETUP_TEMPLATE_URL . '/fundifly-charity/free/1/widgets.json'
                    ),
                    'screenshot_url' => WALKER_CORE_SETUP_TEMPLATE_URL . '/fundifly-charity/free/1/screenshot.png',
                    'demo_url' => 'https://demo.walkerwp.com/fundifly-charity',
                    'plugins' => ''
                ),
                'newsetmag-pro' => array(
                    'title' => esc_html__('Fundifly Charity Pro', 'walker-core'),/*Title*/
                    'is_pro' => true,  /*Premium*/
                    'type' => 'premium',
                    'author' => esc_html__('WalkerWP', 'walker-core'),    /*Author Name*/
                    'keywords' => array('fundifly-charity', 'walker-core'),  /*Search keyword*/
                    'categories' => array('pro'), /*Categories*/
                    'template_url' => array(
                        'content' => WALKER_CORE_SETUP_TEMPLATE_URL . '/fundifly-charity/pro/1/content.json',
                        'options' => WALKER_CORE_SETUP_TEMPLATE_URL . '/fundifly-charity/pro/1/options.json',
                        'widgets' => WALKER_CORE_SETUP_TEMPLATE_URL . '/fundifly-charity/pro/1/widgets.json'
                    ),
                    'screenshot_url' => WALKER_CORE_SETUP_TEMPLATE_URL . '/fundifly-charity/pro/1/screenshot.png',
                    'demo_url' => 'https://demo.walkerwp.com/fundifly-charity-pro',
                    'plugins' => ''
                ),
            );
            break;

...
function walker_core_register_pattern_category()
{
    ...
    switch ($wc_current_theme) {
        ...
        case "Manifold":
            $block_pattern_categories = array(
                'manifold-pro' => array('label' => __('Manifold: Pro Patterns', 'walker-core')),
            );
            break;
        case "Nexum":
            $block_pattern_categories = array(
        ...
        case "Fundifly Charity":
            $block_pattern_categories = array(
                'fundifly-charity-pro' => array('label' => __('Fundifly Charity: Pro Patterns', 'walker-core')),
            );
            break;
        default:
            // Do nothing, keep $block_pattern_categories as an empty array
            break;
    }

...
class Walker_Core {
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( __DIR__ ) . 'includes/class-walker-core-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( __DIR__ ) . 'includes/class-walker-core-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( __DIR__ ) . 'admin/class-walker-core-admin.php';
		...
		require_once plugin_dir_path( __DIR__ ) . 'public/class-walker-core-public.php';
		...
		if ( $is_block_theme ) {
			require_once WALKER_CORE_PATH . 'blocks/class-walkercoreblock.php';

			WalkerCoreBlock::get_instance();
		}
